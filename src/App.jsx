              ...
              <div className="flex items-center space-x-1">
                ...
                <div className="ml-1">
                  <svg width="15" height="11" viewBox="0 0 15 11" fill="none" className="text-foreground">
                    <path d="M1.5 4.5C4.5 1.5 10.5 1.5 13.5 4.5M3.5 6.5C5.5 4.5 9.5 4.5 11.5 6.5M5.5 8.5C6.5 7.5 8.5 7.5 9.5 8.5M7.5 10.5H7.5" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                {/* Battery */}
                <div className="ml-1">
                  <svg width="24" height="12" viewBox="0 0 24 12" fill="none" className="text-foreground">
                    <rect x="1" y="2" width="18" height="8" rx="2" stroke="currentColor" strokeWidth="1"/>
                    <path opacity="0.4" d="M21 4V8C21.5523 8 22 7.55228 22 7V5C22 4.44772 21.5523 4 21 4Z" fill="currentColor"/>
