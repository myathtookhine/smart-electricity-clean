  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-30">
      ...
      <div className="mx-4 mb-6">
        <div 
          className="backdrop-blur-xl bg-white/10 dark:bg-black/20 border border-black/10 dark:border-white/10 rounded-3xl px-2 py-4 shadow-2xl"
          style={{
            ...
            {tabs.map((tab) => {
              ...
              return (
                <button
                  ...
                  className={`relative flex flex-col items-center space-y-1 px-6 py-3 rounded-2xl transition-all duration-300 ${
                    isActive 
