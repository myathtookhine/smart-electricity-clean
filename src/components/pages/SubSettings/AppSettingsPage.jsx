import { User, HelpCircle, Smartphone, ChevronLeft, Settings } from 'lucide-react';

export function AppSettingsPage({ onBack }) {
  return (
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-between p-4 bg-muted/20 rounded-2xl hover:bg-muted/30 transition-all duration-300">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-card-foreground">User Details</span>
              </div>
            ...
            <button className="w-full flex items-center justify-between p-4 bg-muted/20 rounded-2xl hover:bg-muted/30 transition-all duration-300">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-card-foreground">Additional Support</span>
              </div>
              <span className="text-xs text-orange-500 font-medium">(Coming soon!)</span>
            </button>
            <button className="w-full flex items-center justify-between p-4 bg-muted/20 rounded-2xl hover:bg-muted/30 transition-all duration-300">
