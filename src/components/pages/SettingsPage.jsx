        ...
        <div className="space-y-4">
          ...
          <div className="bg-card/50 backdrop-blur-sm rounded-3xl shadow-xl border border-border/50 overflow-hidden">
            {[
              ...
              <button
                key={item.label}
                className={`w-full flex items-center justify-between p-4 text-left hover:bg-muted/20 transition-all duration-200 ${
        ...
        <div className="bg-card/30 backdrop-blur-sm rounded-3xl p-6 border border-border/30">
          ...
          <div className="space-y-3">
            {[
              ...
              <div
                key={item.label}
                className="flex justify-between items-center p-3 bg-muted/20 rounded-xl"
              >
